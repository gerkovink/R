...
First create a folder "data" in your project. Then download it from [here](https://javier.science/R/#day-1) and add it to that folder (use Ctrl+S in the browser to download it).
