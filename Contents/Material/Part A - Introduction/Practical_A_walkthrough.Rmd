---
title: "Practical A"
author: "Gerko Vink (with small adaptaions from Javier Garcia-Bernardo)"
...
8. **Have a look at the code in the script and make sure that you understand what is going on. If you do not understand what you are looking at, please ask me (Gerko) during the lecture or [via e-mail](mailto:G.Vink@uu.nl), or ask the workgroup instructor.** 
...
You can find the notebook [`markdown.Rmd` here](exercise_examples/markdown.Rmd).

Have a look at the code in the `markdown.Rmd` file and make sure that you understand what is going on. If you do not understand what you are looking at, please ask during the lecture or via Teams.
...
End of `Practical 1`. Play around with `R` and `R-studio` if you like. We will be using notebooks for the rest of the course.
