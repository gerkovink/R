...
b. You log your own work. Code does not disappear over time, as you save the code in a seperate file. 
...
Your document is now saved. We saved it in a seperate folder so that we are able to create a project out of our practicals. 
