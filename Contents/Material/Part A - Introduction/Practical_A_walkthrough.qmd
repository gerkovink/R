...
You can find the notebook [`quarto.Qmd` here](exercise_examples/quarto.Rmd).

Have a look at the code in the `quarto.Rmd` file and make sure that you understand what is going on. If you do not understand what you are looking at, please ask.
