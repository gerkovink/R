...
You need to download `dataset_boys.csv` from [here](https://javier.science/R/#day-2-nov-16th) and add it to a folder "data" in the same folder as your markdown file. In t
...
If interested, try to set up git in your computer (https://support.posit.co/hc/en-us/articles/200532077)
