...
<!-- Outliers are now less of an issue. This exercise demonstrates that data transformations may easily render our method more valid, but in exchange it makes uur model interpretation more difficult. Parameters now have to be assessed in the `log(conc)` parameter space.  -->
...
<!-- With every unit increase in `lpo`, the logodds of gender increases by.  -->
